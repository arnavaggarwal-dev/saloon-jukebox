...
const getContainingBlock = (element) => {
  ...
  while (node && node !== document.documentElement) {
    ...
    if (style.transform !== "none" || style.perspective !== "none" || style.filter !== "none" || style.willChange.includes("transform") || style.willChange.includes("perspective") || style.willChange.includes("filter") || /paint|layout|strict|content/.test(style.contain)) {
      return node;
    }
    ...
    const enterHandler = (e) => {
      ...
      const leaveHandler = () => {
        ...
        if (cornersRef.current) {
          ...
          const { cornerSize: cornerSize2 } = constants;
          const positions = [
...
export {
  TargetCursor_default as default
};
